...
C     EfluxP - p-component of Eliassen-Palm flux vector
      ...
      COMMON /FFIELDS_evapHR/ evapHR
      COMMON /FFIELDS_precHR/ precHR
      COMMON /FFIELDS_roffHR/ roffHR
      COMMON /FFIELDS_siceHR/ siceHR
      COMMON /FFIELDS_shfwHR/ shfwHR
      COMMON /FFIELDS_sicePH/ sicePH
      ...
      _RS  evapHR  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  precHR  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  roffHR  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  siceHR  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  shfwHR  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  sicePH   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
...
C     evapHR[0,1]  :: Temp. for precipitation flux
C     precHR[0,1]  :: Temp. for precipitation flux
C     roffHR[0,1]  :: Temp. for precipitation flux
C     siceHR[0,1]  :: Temp. for precipitation flux
C     shfwHR[0,1]  :: Temp. for precipitation flux
C     sicePH[0,1]   :: Temp. for precipitation flux
...
C     Above use static heap storage to allow exchange.
     ...
     &                 saltFlux0, saltFlux1, evapHR0, evapHR1, 
     &                 precHR0, precHR1, roffHR0, roffHR1, 
     &                 siceHR0, siceHR1, shfwHR0, shfwHR1,
     &                 sicePH0, sicePH1 
     ...
     &               , pLoad0, pLoad1
      ...
      _RS  evapHR0 (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  precHR0 (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  roffHR0 (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  siceHR0 (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  shfwHR0 (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  sicePH0  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      ...
      _RS  evapHR1 (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  precHR1 (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  roffHR1 (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  siceHR1 (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  shfwHR1 (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  sicePH1  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
