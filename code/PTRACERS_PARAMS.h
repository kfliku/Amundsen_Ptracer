...
C     PTRACERS_ROFF     :: tracer concentration in RunOff
C     PTRACERS_PREC     :: tracer concentration in Precipitation
C     PTRACERS_EVAP     :: tracer concentration in Evaporation
C     PTRACERS_SHFW       :: tracer concentration in shelfice
C     PTRACERS_SICEhr       :: tracer concentration in seaice (orig deduction)
C     PTRACERS_SICEph       :: tracer concentration in seaice (PH calculation)
...
C     PTRACERS_dTLev    :: Timestep for ptracers ( s ), function of level k
      ...
      _RL PTRACERS_ROFF(PTRACERS_num)
      _RL PTRACERS_PREC(PTRACERS_num)
      _RL PTRACERS_EVAP(PTRACERS_num)
      _RL PTRACERS_SHFW(PTRACERS_num)
      _RL PTRACERS_SICEhr(PTRACERS_num)
      _RL PTRACERS_SICEph(PTRACERS_num)
